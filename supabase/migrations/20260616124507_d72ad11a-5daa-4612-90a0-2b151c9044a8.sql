...
GRANT EXECUTE ON FUNCTION public.recalc_obra_totals(uuid) TO service_role;
GRANT EXECUTE ON FUNCTION public.recalc_annex_totals(uuid) TO service_role;
GRANT EXECUTE ON FUNCTION public.recompute_obra_realtime(uuid) TO service_role;
